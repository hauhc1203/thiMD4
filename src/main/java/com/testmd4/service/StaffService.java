...
public class StaffService {
    ...
    public List<Staff> getAllOrderDesc() {
        return (List<Staff>) iStaffRepo.getAllOrderByAgeDESC();
    }
    public List<Staff> getAllOrderASC() {
        return (List<Staff>) iStaffRepo.getAllOrderByAgeASC();
    }
